      ...
      <div className="max-w-[760px] mx-auto px-4 md:px-[30px] pt-[80px]">
        ...
        <NotebookCell cellNumber={3}>
          ...
          <div className="font-mono text-[13px] bg-[#12151A] border border-[#2d3139] p-4 rounded text-[#e1e4e8]">
            ...
            <div className="pl-4">
              <span className="text-[#ff5f56]">'languages'</span>: <span className="text-[#e1e4e8]">[ {portfolioData.about.stats.languages.map(l => '').join(', ')} ]</span>,
            </div>
            <div className="text-[#a4a9b6]">&#125;</div>
          </div>
        </NotebookCell>
        ...
        {/* Education & Internships (Truncated for brevity, but follows same pattern) */}
